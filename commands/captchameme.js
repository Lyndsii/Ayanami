...
module.exports.run = async (client, message, args) => {
  if (!args[0]) {
    ...
    // .then(res => res.json()).then(body => {
      ...
      .setColor(0xffd1dc)
      .setImage("https://api.alexflipnote.dev/captcha?text=" + args.join('%20'))
      .setTitle('A captcha meme has been made by ' + message.author.username + '!~💖')
...
module.exports.info = {
  ...
  voterOnly: false,
  nsfw: false,
  description: 'Sends a captcha meme.',
