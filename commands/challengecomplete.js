...
module.exports.run = async (client, message, args) => {
  if (!args[0]) {
    ...
    // .then(res => res.json()).then(body => {
      ...
      .setColor(0xffd1dc)
      .setImage("https://api.alexflipnote.dev/challenge?text=" + args.join('%20'))
      .setTitle('Challenge Complete!~💖 ' + message.author.username)
...
module.exports.info = {
  ...
  voterOnly: false,
  nsfw: false,
  description: 'Sends a complete challenge.',
